...
Мы ўзрушаныя навіной аб небывалым назіранні за карыстальнікамі інтэрнэту па ўсім свеце з дапамогаю PRISM (праграма назірання) і іншых падобных праграм. Такія магчымасці для назірання, як гэтыя, асабліва калі яны ажыццяўляюцца без кантролю грамадзян, сур’ёзна паграджаюць правам чалавека на свабоду слова і прыватнасці, а таксама асновам нашай дэмакратыі.

Мы ўхваляем інфарматара Эдварда Сноўдэна за яго ўчынак. Калі ўрад сапраўды створаны народам і існуе для народа, не можа быць злачынствам страта інфармацыі аб ходзе і ступенях дзеянняў урада, заяўленых як накіраваныя на абарону грамадства. Прадстаўнік ураду ва ўмовах дэмакратыі абапіраецца на згоду свайго народа. Аднак такая згода не можа існаваць, калі грамадзяне недастаткова інфармаваныя.

Мы з трывогай адзначаем, што ЗША дэманструе абсалютную непавагу да правоў еўрапейскіх грамадзян і, больш агульна, усіх, хто выкарыстоўвае амерыканскія паслугі сувязі і інфраструктуры. Мы таксама адзначаем негатыўны ўплыў на іх саюзнікаў, на суверэнітэт пацярпелых краін і на канкурэнтаздольнасць іх бізнэсу.

Еўропа павінна адрэагаваць на гэтыя выкрыцці з належнай рашучасцю. У святле гэтай сітуацыі важна, каб Еўрапейскі Саюз, замест таго каб стаць саўдзельнікам злоўжывання ўладай, якое вельмі дорага каштуе грамадству, станавіўся сусветным маяком для цыфравых правоў і абароны прыватнага жыцця, для празрыстага ўрада і аховы інфарматараў.
...
Непрымальна, што сакрэтныя магчымасці і практыкі мінуюць дэмакратычны працэс і прадухіляюць крытычнае і рацыянальнае ўзаемадзеянне, неабходнае ў дэмакратычным грамадстве, каб вызначыць належныя і недарэчныя накірункі дзеяння.

Мы заклікаем Еўрапейскі парламент, згодна артыкулу 185 яго правілаў дзяення, сфармаваць следчы камітэт. Факты, якія трэба высвятліць і апублікаваць:

Што з’яўляецца праўдай аб магутнасцях PRISM?
Якія каналы і крыніцы дадзеных гэта сістэма выкарыстоўвала?
Якія адміністратыўная органы ЕС, і, якія дзяржавы удзельніцы ведалі пра PRISM або мелі да яго доступ ды падобных праграм або дадзеных ад іх?
Якія з пазначаных дакументаў (Усеагульная Дэкларацыя Правоў чалавека, Дырэктыва Аховы Дадзеных, Дырэктыва аб Прыватнасці і Электронных Камунікацыях), альбо любыя іншыя законы ЕС былі парушаны?
