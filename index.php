  ...
  <body>
    ...
    <div id="page">
	  ...
	  <li style="-webkit-transform: rotate(2deg); -moz-transform: rotate(2deg); -ms-transform: rotate(2deg); -o-transform: rotate(2deg); transform: rotate(2deg)"><a href="http://pirateparty.org.uk" target="_blank" title="Pirate Party UK"><img src="/logos/pp-uk.png" width="107" height="150"/></a><a href="http://pirateparty.org.uk" target="_blank" title="Pirate Party UK" style="width:107px; height: 150px;"></a></li>
          ...
          <li style="margin-top: 10px; -webkit-transform: rotate(-2deg); -moz-transform: rotate(-2deg); -ms-transform: rotate(-2deg); -o-transform: rotate(-2deg); transform: rotate(-2deg)"><a href="http://polskapartiapiratow.pl/" target="_blank" title="Polska Partia Piratów"><img src="/logos/pp-pl.png" width="100" height="100"/></a><a href="http://polskapartiapiratow.pl/" target="_blank" title="Polska Partia Piratów" style="width:100px; height: 100px;"></a></li>
